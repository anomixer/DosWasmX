...
var wasmImports = {
 ...
 /** @export */ O: _emscripten_sample_gamepad_data,
 /** @export */ N: _emscripten_set_beforeunload_callback_on_thread,
 /** @export */ M: _emscripten_set_blur_callback_on_thread,
 /** @export */ j: _emscripten_set_canvas_element_size,
 /** @export */ m: _emscripten_set_element_css_size,
 /** @export */ L: _emscripten_set_focus_callback_on_thread,
 /** @export */ K: _emscripten_set_fullscreenchange_callback_on_thread,
 /** @export */ J: _emscripten_set_gamepadconnected_callback_on_thread,
 /** @export */ I: _emscripten_set_gamepaddisconnected_callback_on_thread,
 /** @export */ H: _emscripten_set_keydown_callback_on_thread,
 /** @export */ G: _emscripten_set_keypress_callback_on_thread,
 /** @export */ F: _emscripten_set_keyup_callback_on_thread,
 /** @export */ E: _emscripten_set_mousedown_callback_on_thread,
 /** @export */ D: _emscripten_set_mouseenter_callback_on_thread,
 /** @export */ C: _emscripten_set_mouseleave_callback_on_thread,
 /** @export */ B: _emscripten_set_mousemove_callback_on_thread,
 /** @export */ A: _emscripten_set_mouseup_callback_on_thread,
 /** @export */ z: _emscripten_set_pointerlockchange_callback_on_thread,
 /** @export */ y: _emscripten_set_resize_callback_on_thread,
 /** @export */ x: _emscripten_set_touchcancel_callback_on_thread,
 /** @export */ w: _emscripten_set_touchend_callback_on_thread,
 /** @export */ v: _emscripten_set_touchmove_callback_on_thread,
 /** @export */ u: _emscripten_set_touchstart_callback_on_thread,
 /** @export */ t: _emscripten_set_visibilitychange_callback_on_thread,
 ...
 /** @export */ fa: isNode,
 /** @export */ ea: isWorker,
 /** @export */ _: neil_resolution_changed,
 /** @export */ Z: neil_update_frame,
 /** @export */ r: _strftime,
 /** @export */ Y: _strftime_l,
 /** @export */ X: syncSleep,
 /** @export */ h: _system
};
